...
- **Application Repo**: [daniel-tsonkov/simple-cms](https://github.com/daniel-tsonkov/simple-cms)
...
# Complete Setup Commands for daniel-tsonkov/simple-cms
...
The `deployment.yaml` file is automatically updated by the CI/CD pipeline in the [daniel-tsonkov/simple-cms](https://github.com/daniel-tsonkov/simple-cms) repository when new images are built.

**ArgoCD Application:** See [simple-cms/argocd/application.yaml](https://github.com/daniel-tsonkov/simple-cms/blob/main/argocd/application.yaml)

## ⚠️ Manual Changes

Do not edit manifests directly in this repository unless you know what you're doing. Changes should be made in the [simple-cms repository](https://github.com/daniel-tsonkov/simple-cms) first.
EOF
...
1. Go to: https://github.com/daniel-tsonkov/simple-cms/settings/secrets/actions
...
5. Pipeline passed:
   Check: https://github.com/daniel-tsonkov/simple-cms/actions
